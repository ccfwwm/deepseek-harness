...
Keeping desktop fallbacks in individual message components leaves other copy controls without the same recovery. The shared helper owns routing for all callers.
