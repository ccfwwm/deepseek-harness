...
export const SERVICE_API: readonly ServiceApiEntry[] = [
  ...
  },
  {
    ...
    methods: [
      ...
      {
        signature: '@Remote(\'modelCatalog\') modelCatalog(request?: { readonly check?: boolean readonly refresh?: boolean /** Low-resource startup probe; explicit user checks omit this flag. */ readonly background?: boolean readonly provider?: string readonly model?: string }): Promise<ModelCatalog>',
...
export const EVENT_API: readonly EventApiEntry[] = [
  ...
  {
    name: 'api-session/model-catalog',
    mode: 'emit',
    signature: '\'api-session/model-catalog\'(catalog: ModelCatalog): void',
    summary: 'A model probe completed and published the latest shared catalog snapshot.',
    description: 'A model probe completed and published the latest shared catalog snapshot.',
    parameters: [{ name: 'catalog', description: 'current model catalog and availability state.' }],
  },
  {
  ...
  },
  {
    ...
    mode: 'emit',
    signature: '\'mcp-client/status\'(serverName: string, state: \'starting\' | \'active\' | \'error\', error?: string): void',
    summary: 'Live connection state after transport and tool synchronization.',
    description: 'Live connection state after transport and tool synchronization.',
    parameters: [{ name: 'serverName', description: 'Configured MCP server name.' }, { name: 'state', description: 'Current connection lifecycle state.' }, { name: 'error', description: 'Optional diagnostic message when state is `error`.' }],
  },
  {
