...
export const zh = {
  ...
  'file.parsing': '解析中…',
  'file.parsed': '已解析',
  'file.needsVision': '需要视觉解析',
  'file.stored': '已保存，由 Agent 判别',
  'file.pending': '文件',
  'file.unavailable': '当前版本未加载文件解析服务。',
  'file.busy': '当前输入正在提交，请稍后重试。',
  'file.open': '在侧边栏中打开',
  'file.copy': '复制文件',
  'file.copyNamed': '复制文件 {name}',
  'file.status.parsed': '已解析',
  'file.status.needs_vision': '需要视觉解析',
  'file.status.stored': '已保存',
  'input.send': '发送消息',
  ...
  'image.dropTitle': '将文件拖到此处即可添加附件',
  'image.dropDesc': '支持图片和常见文档格式，单个文件最大 {size}',
  ...
  'hero.headline': 'ZeroWall Science',
  'hero.preview': '',
...
export const en = {
  ...
  'file.attach': 'Attach image or file',
  'file.parsing': 'Parsing…',
  'file.parsed': 'Parsed',
  'file.needsVision': 'Needs visual analysis',
  'file.stored': 'Stored for Agent inspection',
  'file.pending': 'File',
  'file.unavailable': 'The file parsing service is unavailable in this build.',
  'file.busy': 'The input is currently submitting. Try again shortly.',
  'file.open': 'Open in sidebar',
  'file.copy': 'Copy file',
  'file.copyNamed': 'Copy file {name}',
  'file.status.parsed': 'Parsed',
  'file.status.needs_vision': 'Needs visual analysis',
  'file.status.stored': 'Stored',
  ...
  'image.copyFailed': 'Could not copy image',
