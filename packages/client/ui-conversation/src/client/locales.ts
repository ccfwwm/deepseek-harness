...
export const zh = {
  ...
  'input.commands': '指令',
  'input.attachments': '添加附件',
  'input.stop': '停止生成',
  'input.send': '发送消息',
  'input.send.queue': '排队发送',
  'input.send.steer': '插话发送',
  'input.accessMode': '访问模式，当前：{name}',
  'file.unavailable': '当前运行时未启用文件附件。',
  'file.busy': '当前会话正在处理，请稍后重试。',
  'file.pending': '待发送文件',
  'file.unnamed': '未命名文件',
  ...
  'file.parsingQueued': '等待解析…',
  'file.parsingRunning': '解析中…',
  'file.parsingDone': '已解析',
  'file.parsingFailed': '解析失败',
  ...
  'context.estimated': '分项为估算值（总占用以模型采样为准）',
...
export const en = {
  ...
  'input.attachments': 'Add attachments',
  'input.stop': 'Stop generating',
  'input.send': 'Send message',
  'input.send.queue': 'Queue message',
  'input.send.steer': 'Steer message',
  'input.accessMode': 'Access mode, current: {name}',
  'file.unavailable': 'File attachments are not available in this runtime.',
  'file.busy': 'The session is busy processing another request.',
  ...
  'file.parsingQueued': 'Waiting to parse…',
  'file.parsingRunning': 'Parsing…',
  'file.parsingDone': 'Parsed',
  'file.parsingFailed': 'Parsing failed',
  ...
  'context.estimated': 'Breakdown is estimated; model samples determine occupancy',
