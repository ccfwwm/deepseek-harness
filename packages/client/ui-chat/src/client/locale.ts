...
export const zh = {
  ...
  'attachment.copying': '正在复制附件…',
  'attachment.copyFailed': '复制失败，请打开附件后下载',
  ...
  'message.turnError.retry': '重试本轮',
  'message.turnError.retrying': '正在重试',
...
export const en = {
  ...
  'attachment.copying': 'Copying attachment…',
  'attachment.copyFailed': 'Copy failed. Open the attachment to download it.',
  ...
  'message.turnError.retry': 'Retry turn',
  'message.turnError.retrying': 'Retrying',
