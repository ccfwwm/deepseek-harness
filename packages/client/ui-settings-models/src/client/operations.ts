...
import type { ModelsWireLike } from './store.ts'
import type {
 ...
 */
export function createModelsOperations(ctx: ClientContext | ModelsWireLike): ModelsOperations {
  const remote = 'remote' in ctx ? ctx.remote : ctx
  return {
