...
Footer shortcuts are collapsed by default and can be expanded independently of sidebar width. Settings stays visible, and the shortcut choice persists in browser storage.
