...
type SessionTreeProps = Pick<
  ...
  | 'insertWorkspaceBefore' | 'insertSessionBefore' | 'workspaceContextActions' | 't' | 'usePanelInfo'
> & {
...
function FlatList({
  ...
  archivedSessionIds, workspaces, usePanelInfo,
...
>) {
  ...
  const baseRows = useMemo(
    () => deriveFlat(list, archivedSessionIds, pendingInteractions, workspaces),
    [list, archivedSessionIds, pendingInteractions, workspaces],
  )
