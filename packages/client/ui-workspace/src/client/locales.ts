...
export const zh = {
  ...
  'archive.title': '归档会话',
  'archive.description': '归档保留完整会话记录。点击标题查看，或恢复到原工作区。',
  'archive.search': '搜索归档会话或工作区',
  'archive.empty': '暂无归档会话',
  'archive.loading': '正在加载归档会话…',
  'archive.restore': '恢复会话',
  'archive.restoring': '正在恢复…',
  'archive.restored': '已恢复，可在会话历史中查看。',
...
export const en = {
  ...
  'archive.description': 'Archived conversations keep their full history. Open a title to view it, or restore it to its workspace.',
  'archive.search': 'Search archived sessions or workspaces',
  ...
  'archive.restored': 'Restored to session history.',
