...
export const zh = {
  ...
  'status.checking': '正在检测模型可用性…',
  'status.available': '可用',
  'status.unavailable': '不可用',
  'status.requiresLogin': '需登录',
  'status.unknown': '未检测',
  'action.sync': '同步模型',
  'action.checkAll': '检测全部模型',
  'action.checkModel': '检测 {model}',
  'modalities.text': '文本',
  'modalities.vision': '视觉',
  'modalities.unknown': '模态未知',
