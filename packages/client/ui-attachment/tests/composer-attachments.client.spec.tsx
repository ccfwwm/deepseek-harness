...
describe('ComposerAttachments', () => {
  ...
  it('shows only the original file icon and name while storage is pending', () => {
  ...
  it('preserves mixed dropped attachments in one intake callback', () => {
    const onAddFiles = vi.fn()
    ...
    fireEvent.drop(document.body, { dataTransfer })
    expect(onAddFiles).toHaveBeenCalledWith([image, pdf])
  })
})
