...
/**
 * Full-viewport mask and centered panel, portaled to document.body outside
 * sidebar transitions. Close paths are the header button, a mask click, and
 * document-level Escape, whose listener lives only while the panel is open.
 */
